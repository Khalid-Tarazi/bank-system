...
private:
    ...
    static void _PerformManageUsersMenueOption(enManageUsersMenuOptions manageUsersMenuOptions) {
...
public: 
    ...
    static void showManageUsersMenu() {
        ...
        _PerformManageUsersMenueOption((enManageUsersMenuOptions) readManageUsersMenueOption());
    }
};
